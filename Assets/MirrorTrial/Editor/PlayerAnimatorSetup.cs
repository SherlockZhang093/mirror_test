...
namespace MirrorTrial.Editor
{
    ...
    public static class PlayerAnimatorSetup
    {
        ...
        static readonly HashSet<string> LoopingStates = new HashSet<string>
        {
            ...
            "LedgeHang", "MonkeyBarIdle", "LadderIdle",
            "LadderClimbUpLeft", "LadderClimbUpRight",
            "LadderClimbDownLeft", "LadderClimbDownRight",
            "BowAim", "BowFull",
        ...
        static readonly IReadOnlyDictionary<string, string> StateClips =
            new Dictionary<string, string>
            {
                ...
                { "LadderGrab", "ClimbGrab.anim" },
                { "LadderIdle", "ClimbIdle.anim" },
                { "LadderClimbUpLeft", "ClimbUpLeft.anim" },
                { "LadderClimbUpRight", "ClimbUpRight.anim" },
                { "LadderClimbDownLeft", "ClimbDownLeft.anim" },
                { "LadderClimbDownRight", "ClimbDownRight.anim" },
                { "LadderClimbFinish", "LadderClimbFinish.anim" },
                { "LadderJumpPrepare", "ClimbJumpPrepare.anim" },
